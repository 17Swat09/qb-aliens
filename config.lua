...
Config.SpawnZombie 			= 4					-- Number of zombies to spawn per player.
Config.MinSpawnDistance 		= 40 					-- Minimum distance zombies spawn from player.
Config.MaxSpawnDistance 		= 70 					-- Max distance zombies spawn from player.
